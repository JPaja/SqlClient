...
namespace Microsoft.Data.SqlClient.Criptography.PEM
{
    internal static class PemKeyImportHelpers
    {
            ...
            ImportEncryptedKeyAction<TPass> importAction)
        {
            ...
            {
                ReadOnlySpan<char> label = pem.Slice(fields.LabelStart, fields.LabelLenght);
                ...
                pem = pem.Slice(fields.LocationEnd);//[offset..];
            }
            ...
            ReadOnlySpan<char> base64Contents = foundSlice.Slice(foundFields.Base64DataStart, foundFields.Base64DataLenght);//[foundFields.Base64Data];
        ...
        public static void ImportPem(ReadOnlySpan<char> input, FindImportActionFunc callback)
        {
            ...
            while (PemEncoding.TryFind(pem, out PemFields fields))
            {
                ReadOnlySpan<char> label = pem.Slice(fields.LabelStart);//[fields.Label];
