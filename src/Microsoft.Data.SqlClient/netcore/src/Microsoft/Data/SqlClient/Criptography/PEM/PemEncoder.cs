    ...
    internal static class PemEncoding
    {
        ...
        public static bool TryFind(ReadOnlySpan<char> pemData, out PemFields fields)
        {
            ...
            while ((preebIndex = pemData.IndexOfByOffset(PreEBPrefix, areaOffset)) >= 0)
            {
                ...
                ReadOnlySpan<char> label = pemData.Slice(labelStartIndex, preebEndIndex - labelStartIndex);//[labelRange];
                ...
                if (!TryCountBase64(pemData.Slice(contentStartIndex, postebStartIndex - contentStartIndex), out int base64start, out int base64end, out int decodedSize))
                {
                    goto NextAfterLabel;
                }
                ...
                fields = new PemFields(labelStartIndex, preebEndIndex, contentStartIndex + base64start, contentStartIndex + base64end, preebIndex, pemEndIndex, decodedSize);
                return true;
