...
namespace Microsoft.Data.SqlClient
{
    ...
    internal sealed partial class TdsParser
    {
        ...
        private void SendPreLoginHandshake(byte[] instanceName, bool encrypt, bool hasCertificate)
        {
                ...
                switch (option)
                {
                    ...
                    case (int)PreLoginOptions.ENCRYPT:
                        ...
                        else
                        {
                            ...
                            //ENCRYPT_CLIENT_CERT = 0x80 is flag that enables server  more info on https://docs.microsoft.com/en-us/openspecs/windows_protocols/ms-tds/60f56408-0188-4cd5-8b90-25c6f2423868
                            if (hasCertificate)
                                payload[payloadLength] |= 0x80; 
