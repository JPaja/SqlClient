...
namespace Microsoft.Data.SqlClient
{
    sealed internal partial class SqlConnectionFactory : DbConnectionFactory
    {
        ...
        override protected DbConnectionInternal CreateConnection(DbConnectionOptions options, DbConnectionPoolKey poolKey, object poolGroupProviderInfo, DbConnectionPool pool, DbConnection owningConnection, DbConnectionOptions userOptions)
        {
            ...
            if (opt.UserInstance)
            {
                ...
                { // Non-pooled or pooled and no connections in the pool.
                    ...
                    try
                    {
                        ...
                        sseConnection = new SqlInternalConnectionTds(identity, sseopt, key.Credential, null, "", null, false, key.ClientCertificate, applyTransientFaultHandling: applyTransientFaultHandling);
            ...
            return new SqlInternalConnectionTds(identity, opt, key.Credential, poolGroupProviderInfo, "", null, redirectedUserInstance, key.ClientCertificate, userOpt, recoverySessionData, applyTransientFaultHandling: applyTransientFaultHandling, key.AccessToken, pool);
        }
        ...
        {
            //TODO: ADD Support for Client Certificate
